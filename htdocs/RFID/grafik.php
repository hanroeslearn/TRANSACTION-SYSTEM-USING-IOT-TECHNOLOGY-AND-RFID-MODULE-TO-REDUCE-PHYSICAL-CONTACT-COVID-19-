<?php  
 ...
 $query = "SELECT januari, count(*) as number FROM status GROUP BY januari";  
...
<html>
	...
	<body>
		...
		<ul class="topnav">
			...
			<li><a class="active" href="grafik.php">Grafik Umum</a></li>
			<li><a href="grafik_klumutan.php">Klumutan</a></li>
			<li><a href="grafik_sumbersari.php">Sumbersari</a></li>
		</ul>
		<br>
		<br /><br />  
           <div style="width:100%;">  
                <h3>Grafik Status Pencairan Bantuan Sosial</h3>  
